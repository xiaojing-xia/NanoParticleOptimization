...
LOG_DEST = "../saved_data/fws_shuffled_10initial_test1_beta=0p5.csv"
FLAG_DEST = "../saved_data/flag_shuffled_10initial_test1_beta=0p5.csv"
def check_last_run():
...
def recommend(train_x, train_y, best_y, bounds, n_trails = 1):
    ...
    UCB = UpperConfidenceBound(single_model, beta=0.5)
...
def main():
    ...
    parser.add_argument("-c", "--configs", dest="configs",
                       default="common/defaults1_1.cfg",
