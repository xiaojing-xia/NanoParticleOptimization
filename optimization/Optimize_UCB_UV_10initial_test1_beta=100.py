...
LOG_DEST = "../saved_data/fws_shuffled_10initial_test1_beta=100.csv"
FLAG_DEST = "../saved_data/flag_shuffled_10initial_test1_beta=100.csv"
def check_last_run():
...
def main():
    ...
    parser.add_argument("-c", "--configs", dest="configs",
                       default="common/defaults1_2.cfg",
