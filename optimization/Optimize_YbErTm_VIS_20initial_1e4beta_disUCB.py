...
LOG_DEST = "../saved_data/fws_YbErTm_VIS_10initial_beta=1e4_disUCB.csv"
FLAG_DEST = "../saved_data/flag_YbErTm_VIS_10initial_beta=1e4_disUCB.csv"
def check_last_run():
...
def recommend_discrete(train_x, train_y, discrete_choices, n_trails, inequality_constraints ):
    ...
    # EI = qExpectedImprovement(model = single_model, best_f = best_y)
    # Upper Confidence Bound acquisition function
    UCB = UpperConfidenceBound(single_model, beta=10000)
...
def main():
    ...
    parser.add_argument("-c", "--configs", dest="configs",
                       default="common/defaults_YbErTm.cfg",
