...
LOG_DEST = "../saved_data/fws_shuffled_40initial_KS_lin_beta=100.csv"
FLAG_DEST = "../saved_data/flag_shuffled_40initial_KS_lin_beta=100.csv"
def check_last_run():
...
def main():
    ...
    parser.add_argument("-c", "--configs", dest="configs",
                       default="common/defaultsKS_lin_40init.cfg",
